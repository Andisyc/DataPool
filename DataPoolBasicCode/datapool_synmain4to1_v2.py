...
def four_to_one_less_config1_analysis(scope, height, width): # scope: 像素数量的范围, 本函数默认scope=[0, 1024], 即MSCOCO定义的小目标
    ...
    search_patch_1_low = height * width * ratio_height * ratio_width_top
    search_patch_2_low = height * width * ratio_height * (1-ratio_width_top)
    search_patch_3_low = height * width * (1-ratio_height) * ratio_width_bot
    search_patch_4_low = height * width * (1-ratio_height) * (1-ratio_width_bot)
    ...
    return (ratio_width_top, ratio_width_bot, ratio_height, # ratio_area, 
...
def four_to_one_less_config1_synthetise(img1, img2, img3, img4, lab1, lab2, lab3, lab4, ratio_width_top, ratio_width_bot, ratio_height, count, height, width): # ratio_area, 
    # 取得合成图新宽高与缩放模式
