...
def four_to_one_less_config1_analysis(scope, height, width): # scope: 像素数量的范围, 本函数默认scope=[0, 1024], 即MSCOCO定义的小目标
    ...
    return (ratio_area, ratio_width_top, ratio_width_bot, ratio_height,
...
class four_to_one_less_config1_search:
    def __init__(self, list1, list2, list3, list4, csv_path, ratio_area, ratio_width_top, ratio_width_bot, ratio_height, height, width):
        self.list1 = list1
        self.list2 = list2
        self.list3 = list3
        self.list4 = list4
        ...
        if len(self.potential_area_1) != 0 and len(self.potential_area_2) != 0 and len(self.potential_area_3) != 0 and len(self.potential_area_4) != 0:
            ...
            while(len(self.potential_area_1) != 0 and len(self.potential_area_2) != 0 and len(self.potential_area_3) != 0 and len(self.potential_area_4)):
                ...
                four_to_one_less_config1_synthetise(img1, img2, img3, img4, lab1, lab2, lab3, lab4, 
                                                    self.ratio_area, self.ratio_width_top, self.ratio_width_bot, self.ratio_height, 
...
def four_to_one_less_config1_synthetise(img1, img2, img3, img4, lab1, lab2, lab3, lab4, ratio_area, ratio_width_top, ratio_width_bot, ratio_height, count, height, width):
    # 取得合成图新宽高与缩放模式
