...
@author: Cheng Yuxuan Original, DataPool Synthetise Control
"""
# import cv2
"""
...
if __name__ == "__main__":
    # 设定target_info路径
    csv_path = 'D:/AICV-DSTRethink/Code-DataPoolTest&Results/VOC_0712trainval_MultiObject.csv' # VOC_0712trainval_SingleMultiMix.csv / VOC_0712trainval_ObjectInfo.csv
    ...
    scope, height, width = [0, 4096], 512, 512 # 32 * 32 = 1024, 64 * 64 = 4096
    ...
    for i in ratio_height:
        for j in ratio_width_top:
            for k in ratio_width_bot:
                ...
                syn_tool_4lc1.do_search(save_path + 'h' + str(round(i,2)) + '_wt' + str(round(j,2)) + '_wb' + str(round(k,2)) + '/' + name + '_', scope)
    """
    # 四合一构型2增强, 生成图小于原图
