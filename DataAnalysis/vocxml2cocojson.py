...
def convert(xml_list, json_file):
    ...
    # print("find {} categories: {} -->>> your pre_define_categories {}: {}".format(
    # len(all_categories), all_categories.keys(), len(pre_define_categories), pre_define_categories.keys()))
...
if __name__ == '__main__':
    ...
    # 保存的json文件
    # save_json_train = 'trainval.json'
    save_json_val = 'D:/AICV-DSTRethink/val.json'
    # save_json_test = 'test.json'
 
    # 初始文件所在的路径
    xml_dir = "D:/AICV-DSTRethink/Datasets_VOC07test/VOCdevkit/VOC2007/Annotations"
