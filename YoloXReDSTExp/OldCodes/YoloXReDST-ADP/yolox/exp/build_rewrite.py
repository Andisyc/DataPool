...
class Exp():
    def __init__(self):
        ...
        self.max_epoch = 300 # max training epoch
        self.warmup_lr = 0 # minimum learning rate during warmup
        self.min_lr_ratio = 0.05
        self.basic_lr_per_img = 0.01 / 64.0 # learning rate for one image. During traing, lr will multiply batchsize.
        self.scheduler = "yoloxwarmcos" # name of LRScheduler
        self.no_aug_epochs = 1 # last epoch to close augmention like mosaic
    ...
    def get_data_loader_s(self, batch_size, is_distributed, no_aug=False, cache_img=False):
        ...
        return train_loader
    """
    def get_data_loader_m(self, batch_size, is_distributed, no_aug=False, cache_img=False):
    ...
    def get_data_loader_l(self, batch_size, is_distributed, no_aug=False, cache_img=False):
...
class BatchCollatorSynthesize(object):
    def __init__(self, input_size): # input_size=[height, width]
