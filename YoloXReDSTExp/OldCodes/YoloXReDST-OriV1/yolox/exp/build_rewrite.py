...
class Exp():
    def __init__(self):
        ...
        # ---------------- model config ---------------- #
        self.num_classes = 2 # detect classes number of model
        ...
        self.max_epoch = 3 # max training epoch
        ...
        self.test_conf = 0.0 # confidence threshold during evalulation/test, boxes whose scores are less than test_conf will be filtered
        self.nmsthre = 0.65 # nms threshold
        
        self.seed = None
        self.traindata  = r'D:/AICV-YoloXReDST-Orig/datasets/'
        self.testdata = r'D:/AICV-YoloXReDST-Orig/datasets/'
