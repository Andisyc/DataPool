...
class YOLOXHead(nn.Module):
    ...
    def get_losses(self, imgs, x_shifts, y_shifts, expanded_strides, labels, outputs, origin_preds, dtype):
        ...
        loss_small = lossiou[small_index].sum()
        loss_medium = lossiou[medium_index].sum()
        loss_large = lossiou[large_index].sum()
        ...
        return loss, 5.0 * loss_iou, loss_obj, loss_cls, loss_l1, num_fg / max(num_gts, 1), ratio_scale, [loss_small, loss_medium, loss_large]
