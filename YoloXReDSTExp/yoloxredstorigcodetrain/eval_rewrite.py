...
class Exp():
    def __init__(self):
        ...
        self.testdata = "/mnt/yoloxredstorig2/datasets_FaceMask_trainval/"
...
def make_parser():
    ...
    parser.add_argument("-c", "--ckpt", default="/mnt/yoloxredstorig2/YOLOX_outputs/build_rewrite/best_ckpt.pth", type=str, help="ckpt for eval")
