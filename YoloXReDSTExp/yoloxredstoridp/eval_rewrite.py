...
class Exp():
    def __init__(self):
        ...
        self.testdata = "/mnt/yoloxrecuda/datasets_VOC07test/"
...
def make_parser():
    ...
    parser.add_argument("-c", "--ckpt", default="/mnt/yoloxredstoridp/YOLOX_outputs/build_rewrite/best_ckpt.pth", type=str, help="ckpt for eval")
