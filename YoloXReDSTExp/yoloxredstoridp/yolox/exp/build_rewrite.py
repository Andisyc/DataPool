...
class Exp():
    def __init__(self):
        ...
        self.seed = None
        self.traindata  = r'/mnt/yoloxrecuda/datasets_VOC0712_trainval/'
        self.testdata = r'/mnt/yoloxrecuda/datasets_VOC0712_trainval/'
    ...
    def get_data_loader_4to1(self, batch_size, is_distributed, no_aug=False, cache_img=False):
    ...
    def get_data_loader_dp(self, batch_size, is_distributed, no_aug=False, cache_img=False):
