...
import sys
sys.path.append(r'/yoloxrecuda') # r'D:\AICV-YoloXRe
            ...
            for self.iter in range(self.max_iter):
                ...
                if (self.iter + 1) % self.exp.print_interval == 0:
                    ...
                    logger.info("{}, mem: {:.0f}Mb, {}, {}, lr: {:.3e}".format(progress_str, gpu_mem_usage(), time_str, loss_str,self.meter["lr"].latest) + \
                               (", size: {:d}, {}".format(self.input_size[0], eta_str)) + (", s_loss: {}, m_loss: {}, l_loss: {}".format(self.loss_sum_small, 
                                self.loss_sum_medium, self.loss_sum_large)))
