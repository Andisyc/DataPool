...
class Exp():
    def __init__(self):
        ...
        # -------------- training config --------------------- #
        self.warmup_epochs = 0 # epoch number used for warmup
        ...
        self.seed = None
        self.traindata  = r'/mnt/yoloxredstorigcodetest/datasets_FaceMask_trainval/'
        self.testdata = r'/mnt/yoloxredstorigcodetest/datasets_FaceMask_trainval/'
