...
class Trainer:
    ...
    def train(self):
        ...
        batch_flag, is_regular, temp_iter, self.iter_normal, self.iter_unnorm = 0, True, 0, 0, 0
        ...
        for self.iter in range(self.max_iter):
            ...
            if (self.iter + 1) % self.exp.print_interval == 0:
                ...
                logger.info("{}, mem: {:.0f}Mb, {}, {}, lr: {:.3e}".format(progress_str, gpu_mem_usage(), time_str, loss_str,
                            ...
                            (", re_batch: {}, ir_batch: {}".format(self.iter_normal, self.iter_unnorm)))
            ...
            # if (self.iter + 1) % 10 == 0 and ratio_scale[0] > 0.1:
